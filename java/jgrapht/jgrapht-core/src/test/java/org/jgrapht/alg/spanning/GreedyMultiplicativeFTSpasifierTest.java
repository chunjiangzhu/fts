 ...
 */
public class GreedyMultiplicativeFTSpasifierTest
{
...
//        runTest(g, Integer.MAX_VALUE, spanner3);
    	...
    	GraphGenerator<String, DefaultWeightedEdge, String> gen =
            new GnmRandomGraphGenerator<>(600, 150000, 42, true, false);
        Graph<String, DefaultWeightedEdge> g = new Pseudograph<>(
            SupplierUtil.createStringSupplier(1), SupplierUtil.createDefaultWeightedEdgeSupplier(), false);
        gen.generateGraph(g);
		...
		GreedyFTSparsifier<String> ftSparsifier = new GreedyFTSparsifier<String>(g, f, eps, rho);
		Set<DefaultWeightedEdge> edges = ftSparsifier.GetFTSparsifier();
		System.out.println("FTSparsifer Size: " + edges.size());
    }
