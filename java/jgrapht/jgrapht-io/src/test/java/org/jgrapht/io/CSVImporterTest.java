...
public class CSVImporterTest
{
    ...
    // added by Chunjiang, 20190108
    @Test
    public void testEdgeListUnDirectedUnweighted()
...
//                     + "4 1\n";
    	...
    	String filePath = "C:\\Users\\cjz18001\\Downloads\\facebook_combined.txt";
    	//String input = new String(Files.readAllBytes(Paths.get(filePath)), StandardCharsets.UTF_8);
    	File file = new File(filePath);

        Graph<String, DefaultEdge> g =
            readGraphfromFile(file, CSVFormat.EDGE_LIST, ' ', DefaultEdge.class, false, false);
